...
$GLOBALS['TL_LANG']['tl_module']['gb_disableDSGVO']   = array('DSGVO Hinweis deaktivieren', 'Hier können Sie dieses Informationsfeld abschalten.');
$GLOBALS['TL_LANG']['tl_module']['gb_DSGVOpagelink']  = array('Link zur Datenschutzerklärung', 'Hier können Sie den Link zur Datenschutzseite eingeben.');
...
$GLOBALS['TL_LANG']['tl_module']['ascending']  = 'älteste zuerst';
